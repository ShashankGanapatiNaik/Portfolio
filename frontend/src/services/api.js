...
// Projects
export const getProjects = (tech) => api.get('/projects', { params: tech ? { tech } : {} });
...
// Resume
export const downloadResume = () => api.get('/resume', { responseType: 'blob' });
export const uploadResume = (formData) => api.post('/resume', formData, {
