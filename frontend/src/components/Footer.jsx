      ...
      <div style={{ maxWidth: "68rem", margin: "0 auto" }}>
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            ...
            <div>
              <p style={{ fontFamily: "var(--font-sans)", fontWeight: 700, fontSize: "0.95rem", color: "var(--text-primary)", margin: 0 }}>
        ...
        >
          <p style={{ fontFamily: "var(--font-mono)", fontSize: "0.75rem", color: "var(--text-light)", margin: 0 }}>
            © {currentYear} Shashank Ganapati Naik. Built with React & Node.js.
          </p>
          <a
            href="#hero"
            style={{
